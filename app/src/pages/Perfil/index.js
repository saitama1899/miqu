    ...
    {  !loading ?  
          apuestas ?  <>
              <div className='flex flex-col flex-wrap mx-auto md:flex-row slide-in-bottom'>
                ...
                <div className='w-full lg:w-[24%] overflow-y-scroll bg-slate-350 bg-opacity-90 shadow-sm rounded h-[70vh] py-4 px-2 md:px-8'>
                  <DatosDePerfil user={user} totalApuestas={apuestas.length} />
                </div>
              </div> </>
          : ''    
    : <LoadingSpinner /> }
